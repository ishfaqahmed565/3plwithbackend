...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        // Get received shipments without rack location
        ...
        return view('agent.dashboard', compact('pendingShipments', 'pendingScan2', 'pendingScan3', 'stats', 'noRackShipments'));
    }
    ...
    public function createUnknownShipment()
    {
        ...
        return view('agent.shipments.create-unknown', compact('clients'));
    }
    ...
    public function storeUnknownShipment(Request $request)
    {
        ...
        $validated['created_by_agent_id'] = $agent->id;
        $validated['received_by_agent_id'] = $agent->id;
        $validated['received_in_warehouse'] = $agent->warehouse;
        ...
        try {
            // Get creator name
            $creatorName = Auth::guard('agent')->user()->name;
            ...
            if (env('WAREHOUSE_NOTIFICATION_EMAIL')) {
                Mail::send('mail.notifications.unknown-shipment-created', [
                    ...
                    $message->to($tos)->subject('Unknown Shipment Created by Agent');
                });
            }
        } catch (\Exception $e) {
            \Log::error('Failed to send unknown shipment notifications: ' . $e->getMessage());
        }
    ...
    public function editUnknownShipment($id)
    {
        ...
        return view('agent.shipments.edit-unknown', compact('shipment', 'clients'));
    }
    ...
    public function updateUnknownShipment(Request $request, $id)
    {
        ...
        return redirect()->route('agent.unknown-shipments')
    ...
    public function pendingShipments()
    {
        ...
        return view('agent.pending-shipments', compact('pendingShipments'));
    }
    ...
    public function noRackShipments()
    {
        ...
        return view('agent.no-rack-shipments', compact('noRackShipments'));
    }
    ...
    public function unknownShipments()
    {
        ...
        return view('agent.unknown-shipments', compact('unknownShipments'));
    }
}
