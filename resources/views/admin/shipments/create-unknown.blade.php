...
<div class="bg-white rounded-lg shadow p-6">
    ...
    <form method="POST" action="{{ route('admin.shipments.store-unknown') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="product_description" rows="3"
                          ...
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('product_description') }}</textarea>
            </div>
        </div>
        ...
        <div class="mb-6">
            ...
            <div id="products-list" class="space-y-4">
                <div class="product-row bg-gradient-to-br from-blue-50 to-white border-2 border-blue-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow duration-200">
            ...
            <div class="mt-4">
                <button type="button" id="add-product" 
                        class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg font-semibold shadow-md hover:shadow-lg transition-all duration-200 transform hover:scale-105">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between mb-2">
                ...
                <button type="button" id="add-line-item" class="text-sm bg-blue-100 text-blue-700 px-3 py-1 rounded">+ Add Item</button>
            </div>
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            <p class="text-sm font-semibold text-blue-900 mb-2">Ready to Create & Receive Shipment</p>
            <p class="text-sm text-blue-800">This will create the shipment and mark it as received in the warehouse.</p>
        </div>
        ...
        <div class="mt-8 flex gap-4">
            ...
            <button type="submit"
                    class="flex-1 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-semibold shadow-md hover:shadow-lg transition-all duration-200">
    ...
    (function () {
        ...
        if (productsList && addProductBtn) {
            ...
            addProductBtn.addEventListener('click', () => {
                ...
                div.className = 'product-row bg-gradient-to-br from-blue-50 to-white border-2 border-blue-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow duration-200';
                div.innerHTML = `
                    <div class="grid grid-cols-12 gap-4">
                        <div class="col-span-12 sm:col-span-5">
                            <label class="block text-xs font-semibold text-gray-600 mb-1.5 uppercase tracking-wide">Product Name *</label>
        ...
        const addLineItemRow = (value = '') => {
            ...
            input.className = 'flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500';
