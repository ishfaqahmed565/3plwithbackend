...
<div class="bg-white rounded-lg shadow p-6">
    ...
    <form method="POST" action="{{ route('admin.shipments.update-unknown', $shipment->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="product_description" rows="3"
                          ...
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('product_description', $shipment->product_description) }}</textarea>
            </div>
        </div>
        ...
        <div class="mt-8 flex gap-4">
            <a href="{{ route('admin.unknown-shipments') }}"
