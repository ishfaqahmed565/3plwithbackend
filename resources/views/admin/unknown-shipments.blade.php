    ...
    <div class="p-6 border-b border-gray-200">
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                <a href="{{ route('admin.shipments.create-unknown') }}" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 font-semibold text-sm">
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 unknown-row" 
                    ...
                    <td class="px-6 py-4 text-sm">
                        <a href="{{ route('admin.shipments.edit-unknown', $shipment->id) }}" class="text-blue-600 hover:text-blue-800 font-semibold">
                            Edit
                        </a>
                    </td>
                </tr>
